...
My approach to the Zero Paradox is informed by twenty-plus years working as an engineer on computing systems. I have been obsessed with finding root causes to problems - and ways to solve for them - my entire adult life, and expressed similar thoughts as a child. I never stopped asking "why." 
...
The real turning point had nothing to do with mathematics. I was building a system inside Gemini to automatically generate and reload Google Keep notes, a way to manage sprawling topics and keep long-form reasoning coherent. 
