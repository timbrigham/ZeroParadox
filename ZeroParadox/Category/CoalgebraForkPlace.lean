...
-- certain constructions there are obtained ASSUMING choice principles rather than shown to need
-- them, and his own preferred coinductive construction needs neither choice nor LLPO). So the
