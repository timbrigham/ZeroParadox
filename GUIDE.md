...
| [ZP-J Illustrated Companion](ZP-J_Illustrated_Companion.pdf) | ZP-J + ZP-J AFA Addendum | Quine atom diagram (⊥ = {⊥}), directed-graph (APG) view of the Quine atom (self-loop), three-way equivalence table, CC-1 restated as an equivalence and CC-2 read as the Quine-atom role, abstraction chain (ValuationStructure → AFAStructure), APG decoration uniqueness |
| [ZP-J Wheel Illustrated Companion](ZP-J_Wheel_Illustrated_Companion.pdf) | ZP-J Wheel Addendum | Wheel / meadow / collapse diagram (∞ ≠ ⊥), division by zero made total, ∞ = /0 and ⊥ = 0·/0, the wheel of fractions construction, why identifying ∞ with ⊥ leaves a one-element wheel, porthole connection |
