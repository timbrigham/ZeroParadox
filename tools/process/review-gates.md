...
4. If PASS: the agent records NOTHING and reports the verdict to the caller, who records the agreement or takes a signature — then proceed with the commit. A FAIL the agent records itself in the verdictLedger.
...
4. If PASS: the agent records NOTHING and reports the verdict to the caller, who records the agreement or takes a signature. A FAIL the agent records itself in the verdictLedger.
