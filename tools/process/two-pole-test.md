# The Two-Pole Test — the measured ZP-K case, the method form, and the INVARIANT null case

**Body for `CLAUDE.md` § `R-TWOPOLE`.** The rule is there; the ZP-K measurement, the three
method-axis failures of 2026-08-07, and the call-out protocol are here.
