...
- [ ] No em dashes
- [ ] README: Axiomatic Commitments current (AX-1 is retired: its shape is T-SNAP, **not** an axiom; that the snap occurs follows from the occurrence commitment, instantiation occurs, together with DA-1); Question Register
