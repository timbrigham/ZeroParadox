...
def main():
    ...
    S.append(f'<text x="{CX}" y="{CY-R-90}" text-anchor="middle" font-size="12.5" fill="#7a7a92" '
             ...
             f'retired as ill-typed; what separates the members is proved property by property (seam_unique_among_named, for the named bottoms, in a lattice with no top; not an edge)</text>')
