...
|-----------|-----------|-----------|
| AX-B1 (binary existence) | `ax_b1_distinct` | `nullState ≠ firstAtomicState` — proved by `decide` on Fin 2; depends only on `propext`, not `Classical.em`; not a novel axiom of this framework |
