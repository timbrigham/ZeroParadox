...
- Foreword: v2.5 → v2.7 - §IV gains the diagonal fixed point keystone (⊥ as the same self-referential fixed point across the layers; Quine atom / Kleene quine / v₂(0)=∞ / categorical initial as faces; the Gödel inversion), anchored to Lawvere's fixed-point theorem as the recognized unification of the classical diagonal family. Honesty fence throughout - ZP situated in the Lawvere lineage, not claimed a proved instance.
