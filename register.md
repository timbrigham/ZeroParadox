...
| ZP-J Self-Reference | v2.2 | ZP-J_Self_Reference.pdf | v1.24 | STALE | v2.2: rendered self-version refs removed — §VII preamble + Open Items register cells (C1 sweep); fixed null glyphs (scaleᵏ modifier-k, garbled ≤ subscript). comp v1.24: directed-graph (APG) diagram for the Quine atom (self-loop + well-founded chain to ∅); arithmetic analogy scoped; "depth" rephrased to intrinsic descent (AR fix: dropped "(its 2-adic valuation)" gloss — descent-depth ≠ v₂; v₂ parallel stays fenced as "a kind of depth"); APG self-loop redrawn as dashed curve exiting right + re-entering top (was a hollow circle reading as a 2nd node, Dan 2026-06-15); scaleᵏ null fixed — formal:19cf7b64 comp:df6b5031 |
