...
| ZP-H Categorical Bridge | v1.14 | ZP-H_Categorical_Bridge.pdf | v1.12 | STALE | v1.14: K-13 vocab fix + endnote version corrected (v1.10→v1.14); comp v1.12: T-SNAP diagram open circles (colored stroke, white fill) — legibility fix — formal:1e26ca53 comp:228ec283 |
