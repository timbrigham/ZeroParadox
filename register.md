...
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.13 | STALE | Companion v1.13: disclaimer "successor null" replaced with standard math (converges to zero in 2-adic metric) — formal:298f2e30 comp:dfc238c3 |
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.15 | STALE | v2.0: Sections VII-X added; comp v1.15: title → "The Quine Atom" (standard AFA term) — formal:f39311c3 comp:ced83f0f |
