...
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.14 | STALE | comp v1.14: norm description clarified (2-adic depth n → norm 2^{-n}); T-IZ table restructured to 4 steps all Lean-proved via t_iz_complete; title updated — formal:298f2e30 comp:c3559f7d |
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.16 | STALE | v2.0: Sections VII-X added; comp v1.16: title reverted to "The Self-Containing Null" — formal:f39311c3 comp:4d5a43ec |
