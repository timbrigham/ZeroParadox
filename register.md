...
| ZP-K Computational Grounding | v1.7 | ZP-K_Computational_Grounding.pdf | v1.9 | STALE | v1.7: version changelog removed from preamble; palette rebuild. comp v1.9: FMC precision (sweep Step 4) — DA-1 Path 1 splits the axiom-free structural fixed point from the literal ⊥={⊥} (ZF+AFA setting) — formal:0c822fa6 comp:169a56af |
