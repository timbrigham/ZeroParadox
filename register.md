...
| ZP-C Information Theory | v1.16 | ZP-C_Information_Theory.pdf | v2.6 | STALE | v1.16: vocab fixes — "null state" → "⊥" throughout body prose; palette rebuild — formal:1df10fda comp:8eb51699 |
...
| ZP-E Bridge Document | v3.18 | ZP-E_Bridge_Document.pdf | v1.11 | STALE | v3.18: vocab fixes — "null state" → "⊥"; version refs removed from body prose; palette rebuild — formal:d46b9bb1 comp:1b4c17b0 |
