...
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.10 | STALE | Companion v1.10: T-IZ step table updated to 4 steps (t_iz_complete closes all via AFA/Kleene); disclaimer self-contained (AR/ER fixes) — formal:298f2e30 comp:4a282212 |
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.11 | STALE | v2.0: Sections VII-X added; comp v1.11: opening paragraph leads with AFA math content; em-dashes removed (AR/ER fixes) — formal:f39311c3 comp:1aeb5b07 |
