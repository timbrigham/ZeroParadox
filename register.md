...
| ZP-J Self-Reference | v2.2 | ZP-J_Self_Reference.pdf | v1.23 | STALE | v2.2: rendered self-version refs removed — §VII preamble + Open Items register cells (C1 sweep); fixed null glyphs (scaleᵏ modifier-k, garbled ≤ subscript) — formal:19cf7b64 comp:9fd0957b |
