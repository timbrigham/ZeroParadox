...
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.15 | STALE | comp v1.15: em-dashes removed; "closed system" language scoped to derivation chain (AR/ER fixes) — formal:298f2e30 comp:b44d6aed |
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.17 | STALE | v2.0: Sections VII-X added; comp v1.17: em-dashes removed; Quine Atom in tagline; 2-adic analogy caveat moved to front (AR/ER fixes) — formal:f39311c3 comp:afca6c26 |
