...
|----------|---------------|----------|-------------------|---------|-------|
| ZP-A Lattice Algebra | v1.14 | ZP-A_Lattice_Algebra.pdf | v1.9 | STALE | v1.14: CC-2 label → Forced Metatheoretic Commitment; ZPJ_ScaleBridge reference added — formal:c20e847b comp:d83fd4c7 |
| ZP-B p-Adic Topology | v1.9 | ZP-B_pAdic_Topology.pdf | v1.10 | STALE | v1.9: K-17 vocab fix — "First Atomic State" → "minimum nonzero state, ε₀" in §I; comp v1.10: vocab sweep — "null state (0)" → "zero (0)" — formal:75ac399e comp:9e3a544c |
...
| ZP-C Information Theory | v1.15 | ZP-C_Information_Theory.pdf | v2.6 | STALE | v1.15: K-19/K-21 vocab fixes; comp v2.6: vocab sweep — null state fixes throughout — formal:a7dbf220 comp:b280141c |
| ZP-D State Layer | v1.11 | ZP-D_State_Layer.pdf | v1.11 | STALE | v1.11: K-11/K-18 vocab fixes — "Topological Isolation" → "Clopen Separation" in DP-1; "first atomic state" → "minimum nonzero state"; comp v1.11: vocab sweep — null state fixes — formal:7f432037 comp:ef802424 |
...
| ZP-G Category Theory | v1.10 | ZP-G_Category_Theory.pdf | v1.7 | STALE | v1.10: hash sync — script modified without full workflow; rebuilt to sync; comp v1.7: vocab sweep — null state + categorical bridge fixes — formal:f9ceca3f comp:05f8a69d |
| ZP-H Categorical Bridge | v1.14 | ZP-H_Categorical_Bridge.pdf | v1.7 | STALE | v1.14: K-13 vocab fix + endnote version corrected (v1.10→v1.14); comp v1.7: vocab sweep — null state + non-null fixes — formal:1e26ca53 comp:48becd87 |
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.7 | STALE | Companion v1.7: depth diagram legibility — larger fonts, Unicode math notation, norm labels below circles (no overlap with = ⊥ sub-label) — formal:298f2e30 comp:de935952 |
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.9 | STALE | v2.0: Sections VII-X added; comp v1.9: cover/disclaimer updated — companion now explicitly covers both ZP-J and ZP-J AFA Addendum — formal:f39311c3 comp:0c097167 |
| ZP-J AFA Addendum | v1.0 | ZP-J_AFA_Addendum.pdf | N/A | N/— | v1.0: Initial release — derivation chain ValuationStructure → AbstractSelfApp → AFAStructure; decoration_unique for finite APGs; reads after ZP-J — formal:acb513cc |
...
| ZP-L Incomputability Convergence | v1.0 | ZP-L_Incomputability_Convergence.pdf | v1.4 | STALE | Companion v1.4: strip footer version — formal:7825902f comp:3a10ee7b |
