...
| ZP-G Category Theory | v1.10 | ZP-G_Category_Theory.pdf | v1.7 | STALE | v1.10: hash sync — script modified without full workflow; rebuilt to sync; comp v1.7: vocab sweep — null state + categorical bridge fixes — formal:f9ceca3f comp:f6960387 |
| ZP-H Categorical Bridge | v1.14 | ZP-H_Categorical_Bridge.pdf | v1.7 | STALE | v1.14: K-13 vocab fix + endnote version corrected (v1.10→v1.14); comp v1.7: vocab sweep — null state + non-null fixes — formal:1e26ca53 comp:e1d8259a |
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.7 | STALE | Companion v1.7: depth diagram legibility — larger fonts, Unicode math notation, norm labels below circles (no overlap with = ⊥ sub-label) — formal:298f2e30 comp:3a464b18 |
