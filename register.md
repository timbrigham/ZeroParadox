...
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.19 | STALE | comp v1.19: norm bound corrected; IsDepthChain/IsStrictStateSequence in key result box; standard math framing (AR fixes) — formal:298f2e30 comp:4bb584c3 |
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.21 | STALE | v2.0: Sections VII-X added; comp v1.21: structural description replaces ZP-A semilattice; section heading scoped; AFA framing clarified (AR fixes) — formal:f39311c3 comp:0700d356 |
