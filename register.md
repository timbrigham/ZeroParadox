...
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.23 | STALE | v2.0: Sections VII-X added; comp v1.23: pronoun fix; abstraction chain direction clarified; remember_box leads with analogy; p-adic removed from disclaimer; "this framework" → "ZP-A" (ER/AR fixes) — formal:f39311c3 comp:3e190d65 |
