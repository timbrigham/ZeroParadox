...
| ZP-O The Fixed-Point Fork | v1.0 | ZP-O_The_Fixed_Point_Fork.pdf | N/A | N/— | v1.0: Initial release — synthesis layer. Abstract fork schema (lfp/gfp collapses iff unique fixed point) proved choice-free in Lean: fork_le, collapse_of_unique, unique_of_collapse, fork_collapse_iff [propext, Quot.sound]. Number-system instance via Ostrowski: completions_exhaustive, real_not_equiv_padic [propext, Classical.choice, Quot.sound]. Generalizes ZFC+Foundation/AFA orthogonal-contact-point claim; three tiers (schema/instances/unification), hard fence (cross-instance identity = type boundary) + soft fence (not every fork is μ/ν). Lean: ZPO.lean, ZPO_Ostrowski.lean — formal:6b571442 |
