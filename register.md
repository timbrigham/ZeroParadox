...
| ZP-I Inside Zero | v1.9 | ZP-I_Inside_Zero.pdf | v1.20 | STALE | comp v1.20: conditions scoped in prose; "(axiom-free)" corrected to "(no sorryAx)" for propext/Classical.choice theorems (ER/AR fixes) — formal:298f2e30 comp:262b393d |
| ZP-J Self-Reference | v2.0 | ZP-J_Self_Reference.pdf | v1.22 | STALE | v2.0: Sections VII-X added; comp v1.22: AFAStructure typeclass used directly; "bounded semilattice" corrected; Aczel specific claims replaced with generic framing (ER/AR fixes) — formal:f39311c3 comp:b6fc3fb7 |
