...
| ZP-H Categorical Bridge | v1.14 | ZP-H_Categorical_Bridge.pdf | v1.11 | STALE | v1.14: K-13 vocab fix + endnote version corrected (v1.10→v1.14); comp v1.11: subtitle/footer 'Categorical Bridge'→'Functor Coherence' — formal:1e26ca53 comp:f45710f9 |
