...
| [Incomputability Convergence](ZP-L_Incomputability_Convergence.pdf) | ZP-L | v1.14 | ε₀ as the exact ordinal threshold the snap is keyed to. (That the snap occurs follows from the occurrence commitment together with DA-1, closed given DP-2.) |
