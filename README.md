...
|----------|-------------|-------------------|-------|
| ZP-A Lattice Algebra | [ZeroParadox/ZPA.lean](ZeroParadox/ZPA.lean) | T1 (partial order), T2 (⊥ minimum), D2 equivalence, T3 (monotonicity), CC-1 (derived in ZP-J) | Clean - April 2026 |
| ZP-F The Counterexamples | [ZeroParadox/ZPF.lean](ZeroParadox/ZPF.lean) | F-DENSITY, F-NO-MIN, F-SNAP-BLOCKED, F-SNAP-IMPOSSIBLE (general ordered field); R-DENSITY, R-NO-MIN, R-SNAP-BLOCKED, R-SNAP-IMPOSSIBLE (ℝ corollaries) | Clean - May 2026 |
