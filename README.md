...
| [The Constructive Snap](ZP-N_The_Constructive_Snap.pdf) | ZP-N | v1.0 | The choice-free constructive companion to ZP-L: the ε₀ snap from below on ordinal notations. The three snap results are choice-free (propext only). Whether ZP-L's Classical.choice at ε₀ is eliminable is UNCLASSIFIED - no choice-free re-proof of those results exists. |
