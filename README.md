...
| [Bridge Document](ZP-E_Bridge_Document.pdf) | ZP-E | v3.38 | The bridge: the snap assembled as a derived theorem across the layers. |
...
| [Keystone Addendum](ZP-J_Keystone_Addendum.pdf) | ZP-J Keystone Addendum | v1.11 | The diagonal-fixed-point keystone: the Lawvere face-split (machine-checked) and the snap as a well-foundedness boundary crossing. Reads after ZP-J. |
| [Computational Grounding](ZP-K_Computational_Grounding.pdf) | ZP-K | v1.18 | Computational grounding: the bottom's structural self-containment, with the computational reading carried as a commitment. |
| [Incomputability Convergence](ZP-L_Incomputability_Convergence.pdf) | ZP-L | v1.9 | ε₀ as the exact ordinal threshold the snap is keyed to. (That the snap occurs follows from the occurrence commitment together with DA-1, closed given DP-2.) |
| [Kleene-Ordinal Bridge](ZP-M_Kleene_Ordinal_Bridge.pdf) | ZP-M | v1.4 | The bridge between the Kleene quine and the ε₀ fixed point. |
