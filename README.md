...
|------|----------|---------|-------|
| [Lattice Algebra](ZP-A_Lattice_Algebra.pdf) | ZP-A | v1.24 | The lattice-algebra foundation: the bottom element ⊥ and the order it induces. |
...
| [Bridge Document](ZP-E_Bridge_Document.pdf) | ZP-E | v3.31 | The bridge: the snap assembled as a derived theorem across the layers. |
...
| [Categorical Bridge](ZP-H_Categorical_Bridge.pdf) | ZP-H | v1.22 | The categorical bridge: the snap holding under all four domain functors. |
