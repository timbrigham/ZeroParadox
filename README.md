...
| [ZP-B pAdic Topology](ZP-B_pAdic_Topology_v1_5.pdf) | ZP-B | v1.5 | AX-B1. MP-1 (design commitment). T0: p=2 derived given MP-1. Q₂ ultrametric. Clopen balls. Total disconnectedness. Topological irreversibility. v1.5: T3 ZP interpretation bullets labelled explicitly — pure topology and ZP-specific framing separated. |
