...
|------|----------|---------|-------|
| [Lattice Algebra](ZP-A_Lattice_Algebra.pdf) | ZP-A | v1.25 | The lattice-algebra foundation: the bottom element ⊥ and the order it induces. |
| [p-adic Topology](ZP-B_pAdic_Topology.pdf) | ZP-B | v1.15 | The 2-adic topology: why p = 2, and why departure from ⊥ is irreversible. |
...
| [Bridge Document](ZP-E_Bridge_Document.pdf) | ZP-E | v3.32 | The bridge: the snap assembled as a derived theorem across the layers. |
| [The Counterexamples](ZP-F_The_Counterexamples.pdf) | ZP-F | v1.7 | The counterexamples: ordered fields (ℝ, ℚ) where the snap cannot occur. |
...
| [Native Categories Addendum](ZP-H_Native_Categories_Addendum.pdf) | ZP-H Native Categories Addendum | v1.3 | The snap floor realized inside each framework's native Mathlib category (TopCat, ModuleCat ℂ, KleisliCat PMF). Reads after ZP-H. |
...
| [Keystone Addendum](ZP-J_Keystone_Addendum.pdf) | ZP-J Keystone Addendum | v1.8 | The diagonal-fixed-point keystone: the Lawvere face-split (machine-checked) and the snap as a well-foundedness boundary crossing. Reads after ZP-J. |
...
| [Incomputability Convergence](ZP-L_Incomputability_Convergence.pdf) | ZP-L | v1.7 | ε₀ as the exact ordinal threshold the snap is keyed to. (That the snap occurs follows from the occurrence commitment together with DA-1, closed given DP-2.) |
