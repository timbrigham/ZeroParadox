...
| ZP-J Wheel of Fractions | [ZPJ_Wheel.lean](ZeroParadox/ZPJ_Wheel.lean), [ZPJ_WheelFrac.lean](ZeroParadox/ZPJ_WheelFrac.lean) | **Wheel** typeclass (11 axioms after Carlström 2001:11), ZPWheelElem concrete instance (all 11 sorry-free), porthole theorems (zpw_inv_zero_eq_inf, zpw_zero_mul_inf_eq_bot, zpw_top_val_iff_inv_is_inf), WheelValuationStructure bridge typeclass; **WheelFrac.instWheel** (the wheel of fractions ⊙_S A = (A × A)/≡_S is a Wheel for any commutative ring A and multiplicative submonoid S - all 11 fields proved, an expanded presentation of Carlström's 8-axiom Def 1.1), **WheelFrac.inf_ne_bot** (∞ ≠ ⊥ given 0 ∉ S - the wheel-vs-meadow discriminator); Classical.choice-free ([propext, Quot.sound]) | Clean - June 2026 |
