...
|------|----------|---------|-------|
| [Lattice Algebra](ZP-A_Lattice_Algebra.pdf) | ZP-A | v1.27 | The lattice-algebra foundation: the bottom element ⊥ and the order it induces. |
| [p-adic Topology](ZP-B_pAdic_Topology.pdf) | ZP-B | v1.16 | The 2-adic topology: why p = 2, and why departure from ⊥ is irreversible. |
...
| [Bridge Document](ZP-E_Bridge_Document.pdf) | ZP-E | v3.34 | The bridge: the snap assembled as a derived theorem across the layers. |
...
| [Native Categories Addendum](ZP-H_Native_Categories_Addendum.pdf) | ZP-H Native Categories Addendum | v1.4 | The snap floor realized inside each framework's native Mathlib category (TopCat, ModuleCat ℂ, KleisliCat PMF). Reads after ZP-H. |
