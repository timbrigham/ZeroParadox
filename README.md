...
|------|----------|---------|-------|
| [Lattice Algebra](ZP-A_Lattice_Algebra.pdf) | ZP-A | v1.28 | The lattice-algebra foundation: the bottom element ⊥ and the order it induces. |
...
| [Bridge Document](ZP-E_Bridge_Document.pdf) | ZP-E | v3.35 | The bridge: the snap assembled as a derived theorem across the layers. |
