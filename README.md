...
| [Computational Grounding](ZP-K_Computational_Grounding.pdf) | ZP-K | v1.23 | Computational grounding: the bottom's structural self-containment, with the computational reading carried as a commitment. |
| [Incomputability Convergence](ZP-L_Incomputability_Convergence.pdf) | ZP-L | v1.13 | ε₀ as the exact ordinal threshold the snap is keyed to. (That the snap occurs follows from the occurrence commitment together with DA-1, closed given DP-2.) |
