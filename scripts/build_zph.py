...
def build():
    ...
    oq_rows = [
        ...
        ['AX-1',
         'Retired —\nshape: T-SNAP\n(ZP-E v2.0);\noccurrence: stated\nseparately',
         'Binary Snap Causality. AX-1 is retired, and its content was split in two. The shape of the Snap is '
         'derived as Theorem T-SNAP in ZP-E v2.0 via the P₀ / L-RUN / TQ-IH / DA-1 chain, and is no longer '
         'an axiom. That the Snap occurs is stated separately, as the occurrence commitment '
         '(tsnap_holds_but_nothing_moves shows T-SNAP does not carry it). T-H3 inherits T-SNAP as a derived result. Not a gap.'],
        ['AX-G1',
         'Axiom —\nnot novel',
