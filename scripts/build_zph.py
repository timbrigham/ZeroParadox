...
def build():
    ...
    E.append(label_box_status(
        ...
        [
            ...
            'T-SNAP: the shape of the Binary Snap is a derived theorem — AX-1&#8217;s shape half is not an axiom, and its occurrence half is a commitment.',
        ]
    ))
    E.append(sp(8))
    ...
    oq_rows = [
        ...
        ['AX-1',
         'Split —\nshape: T-SNAP\n(ZP-E v2.0);\noccurrence: a\ncommitment',
         'Binary Snap Causality. AX-1 bundled the shape of the Snap with its occurrence. The shape half is '
         'derived as Theorem T-SNAP in ZP-E v2.0 via the P₀ / L-RUN / TQ-IH / DA-1 chain, and is no longer '
         'an axiom. The occurrence half, that the Snap happens, was not retired: it is a framework commitment '
         '(tsnap_holds_but_nothing_moves). T-H3 inherits T-SNAP as a derived result. Not a gap.'],
        ['AX-G1',
         'Axiom —\nnot novel',
    ...
    val_rows = [
        ...
        ['IR-ZP: ZP-A through ZP-E imported',
         ...
         'T-SNAP (ZP-E v2.0) noted: AX-1&#8217;s shape half is derived, not axiomatic; its occurrence half is a commitment.'],
        ['IR-2: Inherited labels preserved',
         'Valid — OQ-G1 closed in ZP-G v1.1; OQ-G2, OQ-G3, OQ-G4 resolved here; '
         'BA-G1 updated to R-BA; AX-1&#8217;s shape half updated to T-SNAP (Derived), its occurrence half to a commitment.'],
        ['D-H1: Morphisms of C',
        ...
        ['AX-1 (Binary Snap Causality)',
         'Split — the shape half is derived as T-SNAP in ZP-E v2.0 and is no longer an axiom; '
         'T-H3 and all downstream results inherit the derived status for the shape. '
         'The occurrence half, that the Snap happens, was not retired: it is a framework commitment.'],
        ['AX-G1, AX-G2',
