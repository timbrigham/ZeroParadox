...
def build():
    ...
    E.append(body(
        ...
        'equals execution at P₀). That closes the shape half of AX-1, which had bundled the '
        'Snap\'s shape with its occurrence; the occurrence half remains a commitment. <b>ZP-G</b> and <b>ZP-H</b> extend the result categorically: '
