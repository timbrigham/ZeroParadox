"""
Build: The Philosophical Question That Started This (v1.18)
...
def build():
    ...
    E.append(body(
        ...
        '<b>T-SNAP</b> — the shape of the Binary Snap as a theorem — through DA-1 (instantiation '
        'equals execution at P₀). With it AX-1 is retired: the shape '
        'of the Snap is proved as T-SNAP, and that the Snap occurs is stated separately, as the occurrence commitment. <b>ZP-G</b> and <b>ZP-H</b> extend the result categorically: '
