...
IS_FACES = [
    ...
    ("verb", "a *change of frame*, valuation face: the same ω-tower's encodings descend to the 2-adic floor 0 = ⊥ (the ascent to ε₀ resolving onto a new bottom ⊥ₙ₊₁) and, through the Riemann-sphere inversion that swaps 0 ↔ ∞, rise to ∞. The inversion is the passage between the two charts",
     ["snap_is_frameflip", "snap_frameflip_tower_tendsto_infty"]),
    ("verb", "a *change of frame*, category face: the categorical seam realizes the same frame-flip as an op-self-dual zero object of the module category ModuleCat ℂ - initial and terminal at once, with the op-duality frame-change swapping the two",
