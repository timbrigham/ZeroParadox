"""
Build ZP-A: Lattice Algebra (v1.26)
...
def build():
    ...
    E.append(label_box('OQ-A1 — Sufficiency of Monotonicity  [OQ-A1b CLOSED by A1&#8211;A4; OQ-A1a: no reason to restrict to join-irreducibles (well-founded carriers); placement in the ordinal tower conditional on OQ-E2]', [
        ...
        'Separately, where the step is placed in the ordinal tower is conditional on OQ-E2: given the alignment h&#949;<sub>0</sub>, nothing below &#949;<sub>0</sub> fires, because &#949;<sub>0</sub> is at once the supremum of the tower&#8217;s stages and the least fixed point of &#945; &#8614; &#969;<super>&#945;</super> (snap_unconditional, epsilon0_min_eq_max).',
    ...
    E.append(data_table(
        ...
        [['(L, &#8744;, &#8869;) as join-semilattice', 'Derived (A1&#8211;A4) — ZP-D: algebraic structure of state space'],
         ...
         ['OQ-A1 — increment selection', 'OQ-A1b CLOSED by A1&#8211;A4; OQ-A1a: no reason to restrict to join-irreducibles (well-founded carriers); placement in the ordinal tower conditional on OQ-E2']],
        [2.5*inch, 4.0*inch]
    ))
    ...
    E.append(data_table(
        ...
        [['A1&#8211;A4 join-semilattice axioms', 'Valid — Axioms; self-contained'],
         ...
         ['OQ-A1: Sufficiency of monotonicity', 'OQ-A1b CLOSED by A1&#8211;A4; OQ-A1a: no reason to restrict to join-irreducibles (well-founded carriers); placement in the ordinal tower conditional on OQ-E2']],
        [2.5*inch, 4.0*inch]
    ))
