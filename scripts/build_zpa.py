"""
Build ZP-A: Lattice Algebra (v1.27)
...
def build():
    ...
    E.append(label_box('OQ-A1 — Sufficiency of Monotonicity  [OQ-A1b CLOSED by A1&#8211;A4; OQ-A1a: no reason to restrict to join-irreducibles (well-founded carriers); placement in the ordinal tower conditional on the alignment hypothesis h&#949;<sub>0</sub>]', [
        ...
        'Separately, where the step is placed in the ordinal tower is conditional on the alignment hypothesis: given h&#949;<sub>0</sub>, nothing below &#949;<sub>0</sub> fires, because &#949;<sub>0</sub> is at once the supremum of the tower&#8217;s stages and the least fixed point of &#945; &#8614; &#969;<super>&#945;</super> (snap_unconditional, epsilon0_min_eq_max); deriving h&#949;<sub>0</sub> is open, as the Classical.choice inversion conjecture.',
