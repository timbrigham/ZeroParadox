"""
Build ZP-F: The Counterexamples (v1.7)
...
def build():
    ...
    E.append(body(
        ...
        '(tsnap_holds_but_nothing_moves), so that it is taken follows from the occurrence commitment (instantiation occurs) together with DA-1 (closed given DP-2). '
