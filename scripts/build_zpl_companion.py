...
def build():
    ...
    E.append(cbody(
        ...
        '&#949;&#8320; is provable in PA. Being enough scales upward &#8212; anything '
        '&#949;&#8320; steps of induction can do, more steps can do too &#8212; so the '
        '1936 result alone would be equally true of any larger ordinal. What pins the '
    ...
    E.append(remember_box(
        ...
        'Gentzen&#8217;s results together establish that &#949;&#8320; is the '
