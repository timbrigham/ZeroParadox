...
def build():
    ...
    E.append(cbody(
        ...
        'Arithmetic, and it takes two of his results rather than one: transfinite '
        'induction up to &#949;&#8320; is enough to prove PA consistent (1936), and '
        'that induction is not itself provable in PA (proved directly in 1943). '
        'Being enough scales upward &#8212; anything &#949;&#8320; steps of induction '
        'can do, more steps can do too &#8212; so the 1936 result alone would be '
        'equally true of any larger ordinal. It is the second result that pins the '
        'value to exactly &#949;&#8320;: the exact ordinal boundary of PA&#8217;s own '
        'proof machinery, the furthest point its provability reaches before a strictly '
        'stronger system is required.'))
    E.append(cbody(
    ...
    E.append(remember_box(
        ...
        'Gentzen&#8217;s two results together establish that &#949;&#8320; is the '
        'specific ordinal where PA&#8217;s proof-theoretic strength is exhausted '
        '&#8212; transfinite induction up to &#949;&#8320; suffices to prove PA '
        'consistent (1936), and that induction is not itself provable in PA '
        '(proved directly in 1943). ZP-L established &#949;&#8320; as '
