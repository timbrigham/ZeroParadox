...
def build():
    ...
    E.append(body(
        ...
        'successor reading (t_iz_limit_is_new_null in ZeroParadox/Order/SnapCannotBe.lean). '
    ...
    oq_rows = [
        ...
        ['AX-1: Binary Snap Causality',
         'RETIRED — shape proved as T-SNAP (ZP-E); occurrence stated separately as the occurrence commitment',
         'AX-1 (Binary Snap Causality) is retired. Its content was split in two: the shape of the snap is proved, as Theorem T-SNAP, and that the snap occurs is stated separately, as the occurrence commitment '
