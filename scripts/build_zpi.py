...
def build():
    ...
    oq_rows = [
        ...
        ['AX-1: Binary Snap Causality',
         'SPLIT — shape CLOSED by T-SNAP (ZP-E); occurrence a commitment',
         'AX-1 bundled the shape of the Snap with its occurrence. The shape half is no longer an axiom: it is Theorem T-SNAP, derived in ZP-E. '
         'The occurrence half, that the Snap happens, was not retired: it is a framework commitment (tsnap_holds_but_nothing_moves). '
         'T-IZ extends T-SNAP to the ordinal limit.'],
        ['Remaining axioms',
         'INTENTIONAL — AX-B1, AX-G1, AX-G2',
         'These are the named axioms. AX-1&#8217;s occurrence half is not on this list because it is a commitment, not a named axiom. T-IZ requires no additions.'],
    ]
    E.append(data_table(
