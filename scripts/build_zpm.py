...
def build():
    ...
    E.append(axiom_box(
        ...
        [
            ...
            'Classical.choice is reached through Mathlib\'s numbering '
            ...
            'numbering\'s footprint is essential is not measured. ZP-K Section IV tabulates '
            'the measured footprints.',
