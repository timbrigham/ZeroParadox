...
def commitments_table():
    ...
    rows = [
        ...
        ('AX-1',  'Retired: shape → Theorem T-SNAP; occurrence stated separately',
         ...
         'is proved, as Theorem T-SNAP, via '
         'the L-RUN / TQ-IH / DA-1 chain in ZP-C and ZP-E, and that the Snap occurs is stated separately, '
         'as the occurrence commitment (tsnap_holds_but_nothing_moves shows T-SNAP does not carry it).'),
