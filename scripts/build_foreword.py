...
def commitments_table():
    ...
    rows = [
        ...
        ('AX-1',  'Split: shape → Theorem T-SNAP; occurrence a commitment',
         'Binary Snap Causality. Previously an axiom, bundling the shape of the Snap with its occurrence. '
         'The shape half is no longer an axiom: it is derived as Theorem T-SNAP via '
         'the L-RUN / TQ-IH / DA-1 chain in ZP-C and ZP-E. The occurrence half, that the Snap happens, '
         'was not retired: it is a framework commitment (tsnap_holds_but_nothing_moves).'),
