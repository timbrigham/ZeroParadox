    ...
    E += [
        ...
        bridge_box(
            ...
            [
                ...
                'ordinal up to which PA cannot prove transfinite induction. ZP locates the minimum state '
