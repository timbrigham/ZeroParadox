...
def build():
    ...
    E += [Paragraph('THE ZERO PARADOX', S['title']),
          ...
          Paragraph('<i>Supersedes v1.5  |  v1.6: Remark added after AX-B1 clarifying that 0 and 1 are both present as mathematical objects; existence is a property the states represent, not a statement about set membership.</i>', S['subtitle']),
