...
def build():
    ...
    E.append(remark_box(
        ...
        [
            ...
            'proof-theoretic ordinal of Peano Arithmetic, and it takes two '
            'results rather than one: transfinite induction up to &#949;&#8320; '
            'suffices to prove PA consistent (1936), and that induction is not '
            'itself provable in PA (which follows from G&#246;del\'s theorem '
            'together with the 1936 result, and which Gentzen proved directly '
            'in 1943). Sufficiency scales upward, so the 1936 bound alone holds '
            'of any larger ordinal; the unprovability bound is what pins the '
            'value to exactly &#949;&#8320;. This is not claimed or proved here.',
